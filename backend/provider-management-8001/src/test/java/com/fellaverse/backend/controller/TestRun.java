...
class TestRun {
   ...
   void finaAllAdminSelf() throws Exception {
    ...
    @Test
    void finaAlllimitedProductGateway() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:9001/api/management/limitedProduct")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
    ...
    @Test
    void finaAlllimitedProductConsumer() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:8002/management/limitedProduct")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
    ...
    @Test
    void finaAlllimitedProductConsumerGateway() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:9001/management/limitedProduct")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
    ...
    @Test
    void finaAlllimitedProductStatusSelf() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:8001/api/management/limitedProduct/status")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
    ...
    @Test
    void finaAlllimitedProductStatusGateway() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:9001/api/management/limitedProduct/status")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
    ...
    @Test
    void finaAlllimitedProductStatusConsumer() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:8002/management/limitedProduct/status")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
    ...
    @Test
    void finaAlllimitedProductStatusConsumerGateway() throws Exception {
        tokenLoginSuccessSelf();
        HttpResponse<String> response = Unirest.get("http://localhost:9001/management/limitedProduct/status")
                .header("fellaverse-token", adminToken)
                .header("content-type", "application/json")
                .asString();
        System.out.println(response.getStatus());
